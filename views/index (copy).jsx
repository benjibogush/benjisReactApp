...
import Country from './CountryList.js'
import GoogleSearch from './GoogleSearch.jsx'
import MeetBenji from 'public/meetbenji.html'
  ...
  render() {
    return <>
      ...
      <Switch>
        ...
        <Route path='/Email' exact component={EmailApp} /> 
        <Route path='/Email' exact component={MeetBenji} /> 
